...
fetch("http://127.0.0.1:8000/get_vehicles")
.then(res => res.json())
.then(data => {
...
fetch("http://127.0.0.1:8000/add_driver?name="+name+
"&phone="+phone+
...
fetch("http://127.0.0.1:8000/get_drivers")
.then(res=>res.json())
.then(data=>{
...
fetch("http://127.0.0.1:8000/add_trip?vehicle="+vehicle+
"&driver="+driver+
...
fetch("http://127.0.0.1:8000/get_trips")
.then(res=>res.json())
.then(data=>{
...
fetch("http://127.0.0.1:8000/get_fuel")
.then(res=>res.json())
.then(data=>{
...
fetch("http://127.0.0.1:8000/get_maintenance")
.then(res=>res.json())
.then(data=>{
...
fetch("http://127.0.0.1:8000/add_salary?driver_name="+driver+
"&amount="+amount+
"&notes="+notes,{
method:"POST"
})
...
fetch("http://127.0.0.1:8000/get_salary")
.then(res=>res.json())
.then(data=>{
...
Promise.all([
fetch("http://127.0.0.1:8000/get_trips").then(r=>r.json()),
fetch("http://127.0.0.1:8000/get_fuel").then(r=>r.json()),
fetch("http://127.0.0.1:8000/get_maintenance").then(r=>r.json()),
fetch("http://127.0.0.1:8000/get_salary").then(r=>r.json())
])
